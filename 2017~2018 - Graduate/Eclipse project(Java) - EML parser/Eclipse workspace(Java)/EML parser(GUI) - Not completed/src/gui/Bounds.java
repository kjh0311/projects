...
{	
	...
	public static final Rectangle	
		...
		STATE_LABEL = down_from(TABLE, 0, 500, 40),
		RANGE_LABEL = down_from(STATE_LABEL, 0, 500, 20)
		;
	...
	{		
		...
		public static final Rectangle
			...
			CLEAR = down_from(RANGE_LABEL, 10, WIDTH, HEIGHT);
	}
	...
	public static class SpecifyRange
	{
		...
		public static final Rectangle
			...
			USING_TIME = down_from(RANGE, 10, BLOCK_WIDTH*8, HEIGHT)
			;
		...
		START = new DayAndTime(USING_TIME, 10), 
		END = new DayAndTime(START.spinner.year, HEIGHT);
		
		
//		public static final Rectangle
//			USING_TIME = down_from(END.spinner.year, HEIGHT+10, BLOCK_WIDTH*8, HEIGHT);
	}
