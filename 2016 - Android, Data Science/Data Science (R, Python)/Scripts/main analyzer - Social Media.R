...
wordcloud <-function(words)
{
  ...
  library(wordcloud)
  wordcloud::wordcloud(names(wordcount), freq = wordcount, scale = c(4,0.5), rot.per = 0, min.freq = 100, random.order = F, random.color = T, colors = palete)
}
