...
range_name1 = "6000-"
range_name2 = "4500-6000"
range_name3 = "3000-4500"
range_name4 = "1500-3000"
range_name5 = "0-1500"
...
list_tweet = file_to_list("Data_OnlySNS2012_2016.txt")

make_all_directories_if_not_exists()
os.chdir(folder_name)
list_candidate = file_to_list("candidate.txt")

#out_file = open("./" + edge_list_folder_name + ".csv", "w")
